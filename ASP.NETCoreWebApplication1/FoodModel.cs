...
namespace ASP.NETCoreWebApplication1
{
    class FoodModel
    {
        private static void Main(string[] args)
        {
            ...
            MLContext mlContext = new MLContext(seed: 99);


            IEnumerable<ImageData> images =
                LoadImageFromDirectory(folder: assetsRelativePath, useFolderNameAsLabel: true);
            ...
            IDataView preProcessedData = preprocessingPipeline
                .Fit(shuffledData).Transform(shuffledData);
